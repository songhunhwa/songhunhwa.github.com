...
Source: [Global CCS Institute](https://hub.globalccsinstitute.com/publications/socio-economic-benefits-solar-and-wind-energy/11-conceptual-framework-analysis)
...
#### 데이터 엔지니어
- 소프트웨어 개발에 대한 경험과 전문성을 보유하고 있으며, 시스템 환경(Spark, Hadoop) 설치 및 관리, 테이블 동기화/자동화 작업 등의 업무를 주로 맡는다. 
